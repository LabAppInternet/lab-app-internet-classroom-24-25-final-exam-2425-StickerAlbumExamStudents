...
INSERT INTO blind_auction (begin_date, end_date, owner_id, sticker_id, initial_price, WINNER_CALCULATED)
VALUES (CURRENT_DATE - INTERVAL '7' DAY, CURRENT_DATE - INTERVAL '1' DAY, 1, 1, 10, false),
       (CURRENT_DATE - INTERVAL '7' DAY, CURRENT_DATE - INTERVAL '1' DAY, 2, 2, 8, false),
       (CURRENT_DATE - INTERVAL '7' DAY, CURRENT_DATE - INTERVAL '1' DAY, 3, 5, 12, false),
       (CURRENT_DATE - INTERVAL '7' DAY, CURRENT_DATE + INTERVAL '1' DAY, 2, 2, 9, false);
