...
public class BlindAuctionAPI {
    ...
    @GetMapping("/blindAuctions/{auctionId}/winnerBid")
    public BidDTO getWinnerBidOfAuction(@PathVariable Long auctionId) {
        return blindAuctionService.getWinnerBidOfAuctionDTO(auctionId);
    }

    @PostMapping("/blindAuctions/bids")
    @ResponseStatus(HttpStatus.CREATED)
